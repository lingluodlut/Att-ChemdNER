...
optparser.add_option(
    "-T", "--train", default="../data/training.ner.doc.token4.BIO",
    help="Train set location"
)
optparser.add_option(
    "-d", "--dev", default="../data/development.ner.doc.token4.BIO",
    help="Dev set location"
)
optparser.add_option(
    "-t", "--test", default="../data/evaluation.ner.doc.token4.BIO",
...
optparser.add_option(
    "-p", "--pre_emb", default="../data/chemdner_pubmed_drug.word2vec_model_token4_d50",
...
CORPUS="chem";
tagFilter=None;
attenScoreFunTotal=['Euclidean','Bilinear','forwardNN','CNN','Cosine','Manhatten'];
attenScoreFun=attenScoreFunTotal[5]
if CORPUS == "chem":
#{{{
...
parameters['loading_path']="./models/chemnerModel/";
parameters['sentencesLevelLoss']=True;
saveModel=False;
